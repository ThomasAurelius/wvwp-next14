...
const EditPlayerForm = ({ player }) => {
	const [state, formAction] = useFormState(updatePlayer, undefined);
			...
			<form action={formAction}>
				...
				<div className={styles.wrapper}>
					<div className={styles.labels}>
						...
						<label htmlFor="agreeCoC">
							Agreed to Code Of Conduct, WVWP rules, and substance abuse
							policies?:{" "}
						</label>
					</div>
					<div className={styles.inputs}>
						...
						<input
							...
							name="dob"
							id="dob"
							value={playerState.dob?.toString()}
						/>
						<input
							className={styles.input}
							onChange={handleChange}
						...
						<input
							...
							name="referrer"
							id="referrer"
							value={playerState.referrer}
						/>
						<select
							className={styles.input}
							onChange={handleChange}
							name="isMaster"
							value={playerState.isMaster}
						>
				...
				<br></br>
				<button className={styles.button} onSubmit={updatePlayer}>
					Update Player
				</button>{" "}
				<br></br>
			</form>
